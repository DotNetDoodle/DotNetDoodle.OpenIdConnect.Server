...
namespace DotNetDoodle.OpenIdConnect.Server
{
    public static class Constants
    {
        ...
        public static class StandardClaims
        {
            ...
            /// all can be present, with the names being separated by space characters. Also note that in 
            ...
            /// or GIF image file), rather than to a Web page containing an image. Note that this URL SHOULD specifically 
            /// reference a profile photo of the End-User suitable for displaying when describing the End-User, 
            ...
            /// is context-specific, and dependent upon the trust framework or contractual agreements within which 
            ...
            /// [ISO639‑1] language code in lowercase and an ISO 3166-1 Alpha-2 [ISO3166‑1] country code 
            /// in uppercase, separated by a dash. For example, en-US or fr-CA. As a compatibility note, some implementations 
            /// have used an underscore as the separator rather than a dash, for example, en_US; Relying Parties MAY choose 
